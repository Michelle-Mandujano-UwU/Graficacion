...
#Usa cv2.VideoCapture para capturar en vivo.
#Convierte a HSV (muy correcto para trabajar con colores).
#Detecta verde con cv2.inRange.
#Crea la ilusión de invisibilidad mezclando la parte verde con el fondo guardado (res2) y lo demás con el frame actual (res1).